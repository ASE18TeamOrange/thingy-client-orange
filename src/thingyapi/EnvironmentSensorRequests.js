class EnvironmentSensorRequests {
  ...
  registerMethods() {
    ...
    this.client.registerMethod("getLastHumidity", this.route+"last/${login}", "GET");
    this.client.registerMethod("getLastGas", this.route+"last/${login}", "GET");
    this.client.registerMethod("getLastLight", this.route+"last/${login}", "GET");

    this.client.registerMethod("logTemperature", this.log_route, "POST");
    this.client.registerMethod("logPressure", this.log_route, "POST");
    this.client.registerMethod("logHumidity", this.log_route, "POST");
    this.client.registerMethod("logGas", this.log_route, "POST");
    this.client.registerMethod("logLight", this.log_route, "POST");
  ...
  logTemperature(context, login, password, token, f) {
    this.client.methods.logTemperature(this.configurePostRequest(context, login, password, token), f);
  }
  ...
  logGas(context, login, password, token, f) {
    this.client.methods.logGas(this.configurePostRequest(context, login, password, token), f);
  }
  ...
  logPressure(context, login, password, token, f) {
    this.client.methods.logPressure(this.configurePostRequest(context, login, password, token), f);
  }
  ...
  logHumidity(context, login, password, token, f) {
    this.client.methods.logHumidity(this.configurePostRequest(context, login, password, token), f);
  }
  ...
  logLight(context, login, password, token, f) {
    this.client.methods.logLight(this.configurePostRequest(context, login, password, token), f);
  }
  ...
  configureGetRequest(context, login, password, token) {
    const args = {
      path: {context: context, login: login},
      headers: {"Content-Type": "application/json", authorization: token},
    };
    return args;
  }

  configurePostRequest(context, login, password, token) {
    const args = {
  ...
  configureDeleteRequest(context, login, password, token) {
    const args = {
      path: {context: context},
      data: {login: login, password: password},
      headers: {"Content-Type": "application/json", authorization: token},
